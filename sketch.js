...
function draw() {
  ...
  textSize(20)
   text("presione tecla para baixo para reniciar",600,100)
    ...
    if (mainCyclist(isTouching || pinkCG,redCG,yellowCG)){
      restart()
    }
}
}
...
function restart(){
  gameState = play;
  gameOver.visible = false
  mainRacerImg1.addAnimation("images/mainPlayer1.png","images/mainPlayer2.png");
  mainRacerImg2.addAnimation("images/mainPlayer3.png");
